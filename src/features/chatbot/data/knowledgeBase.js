export const KB = {
  ...
  services: [
    { name: 'General Consultation', icon: '🩺', desc: 'Free for enrolled students and employees. Walk-in or by appointment.' },
...
export const INTENTS = [
  ...
  { id: 'thanks', patterns: ['thank', 'thanks', 'salamat', 'maraming salamat', 'ty'] },
  ...
  { id: 'appointment', patterns: ['appointment', 'book', 'schedule', 'set', 'reserve', 'reserve a slot'] },
  ...
  { id: 'fees', patterns: ['fee', 'cost', 'charge', 'price', 'bayad', 'libre', 'free', 'payment'] },
