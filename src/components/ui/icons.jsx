// Ported 1:1 from the inline SVG strings in the legacy js/core.js
// (buildSidebar / buildTopbar) so the migrated shell looks identical.
// Each icon accepts standard SVG props (className, etc.) via ...rest.
...
export function SunIcon(props) {
  return (
    <svg className="icon-sun" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export function MoonIcon(props) {
  return (
    <svg className="icon-moon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export function FlaskConicalIcon(props) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M10 2v6.29a2 2 0 0 1-.55 1.38L4 15.5A3 3 0 0 0 6.15 21h11.7A3 3 0 0 0 20 15.5l-5.45-5.83A2 2 0 0 1 14 8.29V2" />
...
export function ToothIcon(props) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 5.5c-1.2-1.5-2.8-2-4.5-1.8C5 4 3.2 6 3.5 9c.2 2 1 3 1.3 5.3.3 2 .2 6.2 2.2 6.2s2-3.5 2.5-5.5c.3-1.2.8-1.5 1.5-1.5s1.2.3 1.5 1.5c.5 2 .5 5.5 2.5 5.5s1.9-4.2 2.2-6.2c.3-2.3 1.1-3.3 1.3-5.3.3-3-1.5-5-3.5-5.3-1.7-.2-3.3.3-4.5 1.8Z" />
    </svg>
  )
}
...
export function PackageXIcon(props) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 22V12" />
      <line x1="9" y1="10.5" x2="15" y2="15.5" />
      <line x1="15" y1="10.5" x2="9" y2="15.5" />
    </svg>
  )
}
...
// "Tap to listen" on a MediBot reply (useSpeechSynthesis.js).
...
// Shown in place of Volume2Icon while that same reply is currently being
// read aloud — tapping it again stops the speech.
...
// Mic button for MediBot's voice input (useSpeechRecognition.js).
